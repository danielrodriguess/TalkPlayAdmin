...
public void preenchertabela(String banco1) {
        ...
        try {
            ...
            do {
                dados.add(new Object[]{
                    banco.rs.getString("emailqueenviou"),
        ...
        tabela1.getColumnModel().getColumn(1).setPreferredWidth(369);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        frmgerenciar ge = new frmgerenciar();
        ge.setTitle("Gerenciamento Talkplay");
        ge.setVisible(true);
