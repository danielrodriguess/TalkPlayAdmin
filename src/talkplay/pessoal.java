 ...
 * @author danie
 */
public class pessoal extends javax.swing.JFrame {
login login = new login();
banco banco = new banco();
mensagem mensagem = new mensagem();
public String email = mensagem.aaa;
public String email1 = login.user;
public String senha = login.senha;
    /**
     * Creates new form pessoal
     */
    public pessoal() {
        initComponents();
        ...
        banco.conexao();
        try{
        String consulta = "select * from admin where email = '" + this.email1.toString()+ "' and senha = '"+this.senha.toString()+"' and status = 'ativo'";            
        ...
        jLabel3.setText("Envie sua mensagem para "+mensagem.aaa+" (máximo de 255 caracteres)");
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(jTextField1.getText().equals("")){
            JOptionPane.showMessageDialog(null, "Preencha o campo");
             ...
             try {         
                PreparedStatement pst = banco.con.prepareStatement("select * from nick where email = '"+email.toString()+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pessoal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
